...
class Data {
  ...
  Data.fromJson(dynamic json) {
    _id = json['id'];
    final dynamic firestoreIdRaw = json['firestore_id'] ??
        json['fire_store_id'] ??
        json['fireStoreId'] ??
        json['driver_firestore_id'];
    _fireStoreId = firestoreIdRaw?.toString();
    if (_fireStoreId != null && _fireStoreId!.trim().isEmpty) {
      _fireStoreId = null;
    }
