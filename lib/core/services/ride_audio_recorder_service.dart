...
class RideAudioRecorderService {
  ...
  Future<void> start({
    ...
    try {
      ...
      final path =
          '${dir.path}/ride_${bookingId}_driver_${DateTime.now().millisecondsSinceEpoch}.m4a';
      ...
      debugPrint('[RideAudio] driver start failed: $error');
    } finally {
      _isBusy = false;
    }
  }
  ...
  Future<void> stopAndUpload({
    ...
    try {
      ...
      debugPrint('[RideAudio] driver upload failed: $error');
    } finally {
      _isBusy = false;
    }
  }
